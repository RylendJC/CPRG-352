...
public class UserService {
    ...
    public boolean insert(String email, boolean active, String first, String last, String password, Role role) throws Exception {
        User user = new User(email, active, first, last, password, role);
        return this.userDB.insert(user);
    }
    
    public boolean update(String email, boolean active, String first, String last, String password, Role role) throws Exception {
        User user = new User(email, active, first, last, password, role);
